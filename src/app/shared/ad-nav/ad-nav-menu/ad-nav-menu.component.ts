import { Component, OnInit, Input , ElementRef, ContentChild,Renderer, AfterContentInit, TemplateRef} from "@angular/core";
...
export class AdNavMenuComponent implements OnInit, AfterContentInit {
  @Input() menuSource: Partial<MenuModel>[];
  
  @ContentChild(AdNavNesterDirective) nesterTemplate;
  @ContentChild(AdNavItemDirective) menuItemTemplate;
  ...
  // @ContentChild(AdNavNesterComponent)
  // nesterTemplate: ElementRef;
