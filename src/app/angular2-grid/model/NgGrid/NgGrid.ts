import { NgGridConfig, NgConfigFixDirection, NgGridRawPosition } from "..";
import { Observable, Subscription } from "rxjs";
import { KeyValueDiffer, ComponentRef } from "@angular/core";
import { NgGridPlaceholderComponent, NgGridItemDirective } from "../../main";
...
protected _posOffset: NgGridRawPosition = null;
protected _adding: boolean = false;
protected _placeholderRef: ComponentRef<NgGridPlaceholderComponent> = null;
...
protected _itemFixDirection: NgConfigFixDirection = "cascade";
protected _collisionFixDirection: NgConfigFixDirection = "cascade";
...
//	Default config
protected static CONST_DEFAULT_CONFIG: NgGridConfig = {
	margins: [10],
	draggable: true,
	resizable: true,
	max_cols: 0,
